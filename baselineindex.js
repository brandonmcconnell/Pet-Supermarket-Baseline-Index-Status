            ...
            // if (feedNotificationsObj.length > 0) {
                        ...
                        for (requiredTask in requiredTasks) {
                            if (returnedTasks.indexOf(requiredTask) === -1) {
                                ...
                                errorRows += '<div class="data-row status-error"><span class="data-value" data-label="id" data-label-clean="ID">'+(dateCheck.length > 0 ? dateCheck : ((todayDate.getMonth()+1)+"_"+todayDate.getDate()+"_"+todayDate.getFullYear()))+"_"+requiredTask+'</span><span class="data-value" data-label="operation" data-label-clean="Operation">'+requiredTasks[requiredTask]+'</span></div>';
                                errorCount++;
                            }
                        }
